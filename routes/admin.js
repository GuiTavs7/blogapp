...
router.get('/posts', isAdmin, (req, res) => {
    res.send('Página de posts do painel de administração');
});
...
router.post('/categorias/edit/:id', isAdmin, (req, res) => {
    ...
    if(!req.body.nome || typeof req.body.nome == "undefined" || req.body.nome == null){
        erros.push({texto: "Nome da categoria é obrigatório"});
    }
    if(!req.body.slug || typeof req.body.slug == "undefined" || req.body.slug == null){
        erros.push({texto: "Slug da categoria é obrigatório"});
    }
    if(erros.length > 0){
...
router.post('/postagens/delete/:id', isAdmin, (req, res) => {
